...
import org.noplay.risorse.security.Roles;
...
public class Utente implements UserDetails {
	...
	/**
	 * I permessi di ogni utente, puÃ² servire se gestiamo i livelli di accesso a
	 * seconda dei permessi di ogni utente Nel nostro caso ne faremo a meno, ma vi
	 * lascio un esempio di come si puÃ² implementare. Ci baseremo solamente sul
	 * ruolo dell'utente
	 */
	@Override
	...
	/**
	 * A seconda se vi interessa avere certe funzionalitÃ , implementate i campi
